...
def process_person_json(clip_data, person_index):
    ...
    return sing_pose_np, sing_scores_np
...
def process_clip_json(json_data, results_root_path, scene_id, clip_id):
    ...
    for person_index in sorted(json_data.keys(), key=lambda x: int(x)):
        ...
        person_pose_np, person_scores_np = process_person_json(json_data, person_index)
